.. 101GradingScript documentation master file, created by
...
3. Download the compiled program from `here <https://trihardstudios-my.sharepoint.com/:f:/p/gjbell/Etrkx_32aV1Ntjxta1Uv8U8BcxE4JH3iVwdkpEPJai--zA?e=8GPcyP>`_. for your platform of choice
...
As far as actually grading, I will go into more specific detail in Grading, but the general process is:
1. Download grades as a CSV from Gradescope for *all* assignments you will be grading
